...
- **Community plugin store** (recommended) — search for *Stonks* in **Settings → Community plugins**, or install from the [directory listing](https://community.obsidian.md/plugins/stonks).
